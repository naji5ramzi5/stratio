...
symbols  = [
  ...
  "AAVEUSDT", "MKRUSDT", "COMPUSDT", "ENJUSDT", "SUSHIUSDT", 
  "YFIUSDT", "CRVUSDT", "ZRXUSDT", "FTMUSDT", "BNTUSDT", 
  "SRMUSDT", "BALUSDT", "CELOUSDT", "EGLDUSDT", "ONEUSDT", 
...
data = {
    "window_size": 5,
    "train_start_date": "2020-01-01 13:30:00",  

...
symbols  = [ 
 "BTCUSDT", "ETHUSDT"]
symbols  = ['SOLUSD', 'GOATUSDT', 'FLOKIUSDT', 'CATIUSDT', 'XRPUSDT', 'BNBUSDT', 'CATUSDT', 'BCHUSD', 'SUNDOGUSDT', 
            'HMSTRUSDT', 'BCHUSDT', 'PUFFERUSDT', 'GRASSUSDT', 'MOODENGUSDT', 'BNBUSD', 'DOGSUSDT', 'DOGEUSD', 'XUSDT', 
